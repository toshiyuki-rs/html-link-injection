 ...
 * reference policy
 */
declare enum ReferencePolicyType {
 ...
 *
 */
declare enum InjectionLocation {
    /**
...
export { Option, LinkItemOption, CrossOriginType, ReferencePolicyType, RelType, InjectionLocation, LinkAttributes, ProcessedLinkItem, EntryNameLinkItem };
